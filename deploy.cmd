...
echo Restoring npm packages for EOC-TeamsFx (this can take several minutes)
echo "%DEPLOYMENT_SOURCE%"
pushd "%DEPLOYMENT_SOURCE%"

echo Restoring npm packages for tabs folder (this can take several minutes)
